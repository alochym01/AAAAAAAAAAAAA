...
//	echo InkThemes_License::is_localhost();
	?>
	<h2 class="title"><?php _e( 'Theme activation', 'black-rider' ); ?></h2>
	<?php if ( InkThemes_License::is_activated() ) { ?>
		<div class="updated"><p><?php _e( 'Your theme is activated.', 'black-rider' ); ?></p></div>
	<?php } else { ?>
	...
	<form id="inkthemes_setting_form" method="post">
		...
		<p><?php _e( 'Activate the theme by entering license key. You will get the license key from our <a target="new" href="http://inkthemes.com/members/member/index">members area</a>.', 'black-rider' ); ?></p>
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e( 'Theme License Key', 'black-rider' ); ?></th>
				<td>
					...
					<p class="description" id="home-description"><?php _e( 'Enter your license key from <a target="new" href="http://inkthemes.com/members/member/index">members area</a>.', 'black-rider' ); ?></p>
					<p style="display:none;" class="error"></p>
				</td>
			</tr>
		</table>
		<p><?php submit_button( __( 'Activate License', 'black-rider' ), 'primary', 'activate_license', false ); ?>
