...
<div class="wrap" id="of_container">
    ...
    <div id="of-popup-save" class="of-save-popup">
        <div class="of-save-save"><?php _e('Options Updated', 'black-rider'); ?></div>
    </div>
    <div id="of-popup-reset" class="of-save-popup">
        <div class="of-save-reset"><?php _e('Options Reset', 'black-rider'); ?></div>
    </div>
    <form action="" enctype="multipart/form-data" id="ofform">
        <?php wp_nonce_field('theme-update-option', 'theme_option_nonce'); ?>
        <div id="header">
            <div class="logo">
                <h2><?php printf(__('%s Options', 'black-rider'), $themename); ?></h2>
            </div>
...
// Rev up the Options Machine
        ...
        <div class="save_bar_top save_bar_right">
            ...
            <input type="submit" value="<?php _e('Save All Changes', 'black-rider'); ?>" class="button-primary" />
        </div>
    </form>
    <div class="save_bar_top save_bar_left">
        <form action="<?php echo esc_attr($_SERVER['REQUEST_URI']) ?>" method="post" style="display:inline" id="ofform-reset">
            <span class="submit-footer-reset">
                <input name="reset" type="submit" value="<?php _e('Reset Options', 'black-rider'); ?>" class="button submit-button reset-button" onclick="return confirm('Click OK to reset. Any settings will be lost!');" />
    ...
    <?php
//} else {
//	printf( '<p>%s</p>', __( 'Your theme license is not activated. Please activate it from <a href="' . admin_url( '/admin.php?page=inkoption-setting' ) . '">here</a> to get complete option of this theme.', 'black-rider' ) );
//}
    ?>
</div>
<!--wrap-->